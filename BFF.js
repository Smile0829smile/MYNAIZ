...
function getIntoFriend(){
    ...
    //Nandia egch
    else if(idFriendCode.value == "nz01nn22gl"){
        // document.body.style.textAlign = "left"
    ...
    //Munkhbileg
    else if(idFriendCode.value == "du10mg10by"){
        // document.body.style.textAlign = "left"
        idH2.innerHTML = "<wonky>" + n1 + "</wonky> <br>Munkhbileg<br><br>"
        idH2.innerHTML +="<wonky>" + n2 + "</wonky> <br>Batsaan<br><br>"
        idH2.innerHTML +="<wonky>" + n3 + "</wonky> <br>Geree tsevrel batsaanaa<br><br>"
        idH2.innerHTML +="<wonky>" + n4 + "</wonky> <br>Batsaanaa sanahgui baina hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n5 + "</wonky> <br>Udur bolgon zoddogt sorry hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n6 + "</wonky> <br>Hell yeah,<br> I have best picture of you lol<br><br>"
        idH2.innerHTML +="<wonky>" + n7 + "</wonky> <br>Uhaalag, Teneg, Uurtai<br><br>"
        idH2.innerHTML += "<button class='customButtons' onClick='myFeedBack()'>Nadaa heleh ug baival dar</button><br><br>"
        idH2.innerHTML += "<button onClick='back()'>butsah</button>"
    }

    //Itgel ah
    else if(idFriendCode.value == "nz00ir19by"){
        // document.body.style.textAlign = "left"
        idH2.innerHTML = "<wonky>" + n1 + "</wonky> <br>Itgel ah<br>Zgr Itgel geh geheer evgu baina hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n2 + "</wonky> <br>Sportlog ah hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n3 + "</wonky> <br>Ahgui nadad ah shig baidagt bylla hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n4 + "</wonky> <br>Ymarch undur ym<br><br>"
        idH2.innerHTML +="<wonky>" + n5 + "</wonky> <br>Beltgel deer haya uimuuleed baidagt sorry<br><br>"
        idH2.innerHTML +="<wonky>" + n6 + "</wonky> <br>Nah<br><br>"
        idH2.innerHTML +="<wonky>" + n7 + "</wonky> <br>Uhaalag, Undur, Sportlog<br><br>"
        idH2.innerHTML += "<button class='customButtons' onClick='myFeedBack()'>Nadaa heleh ug baival dar</button><br><br>"
        idH2.innerHTML += "<button onClick='back()'>butsah</button>"
    }

    //Uilsee egch
    else if(idFriendCode.value == "na00as22gl"){
        // document.body.style.textAlign = "left"
        idH2.innerHTML = "<wonky>" + n1 + "</wonky> <br>Ariun-Uils egch<br><br>"
        idH2.innerHTML +="<wonky>" + n2 + "</wonky> <br>Hugjiltei egch<br><br>"
        idH2.innerHTML +="<wonky>" + n3 + "</wonky> <br>Yr ni tegeel ineedtei ym yrij hugjuudegt bylla<br><br>"
        idH2.innerHTML +="<wonky>" + n4 + "</wonky> <br>Hugjiltei egch ve<br><br>"
        idH2.innerHTML +="<wonky>" + n5 + "</wonky> <br>Haaya Itgel ahiig ML ruu oruulah geed baidagt sorry hha<br><br>"
        idH2.innerHTML +="<wonky>" + n6 + "</wonky> <br>no<br><br>"
        idH2.innerHTML +="<wonky>" + n7 + "</wonky> <br>Eyldeg, Uhaalag, Hicheengui<br><br>"
        idH2.innerHTML += "<button class='customButtons' onClick='myFeedBack()'>Nadaa heleh ug baival dar</button><br><br>"
        idH2.innerHTML += "<button onClick='back()'>butsah</button>"
    }

    //Orgil ah
    else if(idFriendCode.value == "ah91or19by"){
        // document.body.style.textAlign = "left"
        idH2.innerHTML = "<wonky>" + n1 + "</wonky> <br>Orgil ah<br><br>"
        idH2.innerHTML +="<wonky>" + n2 + "</wonky> <br>Hugjiltei ah<br><br>"
        idH2.innerHTML +="<wonky>" + n3 + "</wonky> <br>Delgets ugsund bylla :)<br><br>"
        idH2.innerHTML +="<wonky>" + n4 + "</wonky> <br>Sain zagas baridag baih daa<br><br>"
        idH2.innerHTML +="<wonky>" + n5 + "</wonky> <br>Oroi orlildood bdgt sorry<br><br>"
        idH2.innerHTML +="<wonky>" + n6 + "</wonky> <br>No<br><br>"
        idH2.innerHTML +="<wonky>" + n7 + "</wonky> <br>Hugjiltei, Uhaalag, Uguumur<br><br>"
        idH2.innerHTML += "<button class='customButtons' onClick='myFeedBack()'>Nadaa heleh ug baival dar</button><br><br>"
        idH2.innerHTML += "<button onClick='back()'>butsah</button>"
    }

    //Oyuka egch
    else if(idFriendCode.value == "eg95oe23gl"){
        // document.body.style.textAlign = "left"
        idH2.innerHTML = "<wonky>" + n1 + "</wonky> <br>Oyuka egch<br><br>"
        idH2.innerHTML +="<wonky>" + n2 + "</wonky> <br>Yria egch hha<br><br>"
        idH2.innerHTML +="<wonky>" + n3 + "</wonky> <br>Mni yriag uidahgu sonsdogt bylla hha<br><br>"
        idH2.innerHTML +="<wonky>" + n4 + "</wonky> <br>Aan ene egch Orgil ahiin ehner ym baina<br><br>"
        idH2.innerHTML +="<wonky>" + n5 + "</wonky> <br>Oroi orlildood bdgt sorry<br><br>"
        idH2.innerHTML +="<wonky>" + n6 + "</wonky> <br>No<br><br>"
        idH2.innerHTML +="<wonky>" + n7 + "</wonky> <br>Eyldeg, Hugjiltei, Yria<br><br>"
        idH2.innerHTML += "<button class='customButtons' onClick='myFeedBack()'>Nadaa heleh ug baival dar</button><br><br>"
        idH2.innerHTML += "<button onClick='back()'>butsah</button>"
    }
